...
const _withScopeId = (n) => (pushScopeId("data-v-59dabe7b"), n = n(), popScopeId(), n);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "8a02fd10": unref(tableMinHeightPx),
      "08807d78": unref(tableHeightPx)
    }));
    const {
      bodyTextDirection,
      checkboxColumnWidth,
...
var DataTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-59dabe7b"]]);
